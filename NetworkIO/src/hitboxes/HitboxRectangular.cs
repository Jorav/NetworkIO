...
namespace NetworkIO.src.hitboxes
{
    ...
    class HitboxRectangular : ICollidable
    {
        ...
        public HitboxRectangular(Vector2 position, float rotation, int width, int height)
        {
        ...
        {
            if (c is HitboxRectangular cR)
                return CollidesWithRectangle((HitboxRectangular) cR);
        ...
        public bool CollidesWithRectangle(HitboxRectangular r)
        {
        ...
        private Vector2[] GenerateAxes(HitboxRectangular r)
        {
